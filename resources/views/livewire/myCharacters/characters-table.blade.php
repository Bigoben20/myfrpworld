        ...
        <tbody class="bg-white border-b">
            ...
            <tr class="border-b text-slate-900 dark:bg-slate-800 dark:border-slate-700">
                ...
                <td class="flex gap-2 px-6 py-3">
                    ...
                    active:bg-blue-700 active:shadow-lg"><i class="fa-solid fa-gear"></i> Details</button>
                    ...
                    active:bg-red-700 active:shadow-lg"><i class="fa-solid fa-trash"></i> Delete</button>
                </td>
            </tr>
            @empty
            <tr>
