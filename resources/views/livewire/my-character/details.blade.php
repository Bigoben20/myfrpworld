<div wire:ignore.self class="bg-white dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-2xl mb-16">
                ...
                <div class="flex flex-col border border-gray-800 rounded-xl">
                    ...
                    <div class="grid grid-cols-3 gap-2 px-2 py-2">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" wire:model="characterName"
                        ...
                        <div class="flex flex-col">
                            ...
                            <select type="text" name="type" id="type" placeholder="Type"
                                class="border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:bg-gray-900 rounded-lg focus:ring-sky-500 focus:ring-offset-0">
            ...
            <div class="flex flex-col gap-4 col-span-1 md:col-span-3">
                ...
                <div class="flex flex-col gap-2 border border-gray-800 rounded-xl">
                    ...
                    <div class="flex flex-col gap-2 px-2 pb-2">
                        <div class="flex flex-col">
                            <textarea placeholder="Stunts" rows="31" name="stunts" class="border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:bg-gray-900 rounded-lg focus:ring-sky-500 focus:ring-offset-0"></textarea>
                        </div>
